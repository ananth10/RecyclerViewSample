...
public class UsingGridLayoutManager extends AppCompatActivity {

    RecyclerView mRv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_using_grid_layout_manager);
        mRv=(RecyclerView)findViewById(R.id.foods_list);
        setupRecyclerView(mRv);
    }

    private void setupRecyclerView(RecyclerView recyclerView) {
        GridLayoutManager gridLayoutManager =new GridLayoutManager(UsingGridLayoutManager.this,2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setAdapter(new RecyclerViewAdapter(UsingGridLayoutManager.this,
