...
public class UsingStaggerdLayoutManager extends AppCompatActivity {

    RecyclerView mRv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_using_staggerd_layout_manager);
        mRv=(RecyclerView)findViewById(R.id._stagger_food_list);
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new RecyclerViewAdapter(UsingStaggerdLayoutManager.this,
...
//        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.stagger_grid_item, parent, false);
